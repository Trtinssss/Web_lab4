...
<head>
    ...
    <title>Chỉnh sửa thông tin chi nhánh</title>
    <style>
        table {
...
<form method="POST" action="update_branch.php">
    <table>
        <tr>
            <td colspan="2" id="title">Sửa thông tin chi nhánh</td>
        </tr>
        <tr>
            <td>Tên chi nhánh</td>
            <td>
                <select name="TenCN" id="TenCN" required>
                <?php
                include "connect.php";
        ...
        <tr>
            <td>Tên chi nhánh</td>
            <td><input type="text" name="TenChiNhanh" required></td>
        </tr>
        <tr>
            <td>Địa chỉ</td>
